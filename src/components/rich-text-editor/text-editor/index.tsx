...
type Props = {
    ...
    historyMomoryIndexRef: React.MutableRefObject<number>,
    caretPostionsRef: React.MutableRefObject<number[]>,
...
const index = ({
    ...
    return <div className={className}>
        <div id='inlineStyling' className='flex flex-wrap gap-3'>
        ...
        <div id='alignment' className='flex flex-wrap gap-3'>
        ...
        <div id='listings' className='flex flex-wrap gap-3'>
        ...
        <div id='anchorLink' className='flex flex-wrap items-center gap-3'>
            <div id='linked'>
        ...
        <div id='media' className='flex flex-wrap items-center gap-3'>
            <div id='image'>
        ...
        <div id='code' className='flex flex-wrap items-center gap-3'>
